...
const UserList = () => {
    ...
    const fetchUsers = useCallback(async () => {
        setLoading(true);
        try {
            const response = await axios.get(`${API_BASE_URL}/admin/users`, authConfig);
    ...
    const handleAddUserSubmit = async (e) => {
        e.preventDefault();
        try {
            await axios.post(`${API_BASE_URL}/admin/users`, formData, authConfig);
    ...
    const handleDeleteConfirm = async () => {
        try {
            await axios.delete(`${API_BASE_URL}/admin/users/${userToDelete._id}`, authConfig);
    ...
    const columns = [
        ...
        },
        {
            ...
            renderCell: (params) => (
                <Box>
                    <IconButton size="small" onClick={() => console.log('Edit', params.row._id)} color="primary">
